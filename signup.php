...
<html lang="en">
  <head>
    ...
    <title>Beauty  | Signup Page</title>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+94770151250">+94770151250</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:thamalidilrukshi7@gmail.com" class="mail">thamalidilrukshi7@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p class="para"> 83/B,Bandaragama,Sri Lanka</p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
