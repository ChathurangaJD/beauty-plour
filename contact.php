...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+94757786809">+94757786809</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:chathuranga@gmail.com" class="mail">chathuranga@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p class="para"> 335/5 A1,Ambalangoda,Sri Lanka</p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
